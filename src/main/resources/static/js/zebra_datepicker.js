            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        icon = $('<button type="button" class="Zebra_DatePicker_Icon' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '"><i class="fa fa-calendar"></i><span class="sr-only">Pick a date</span></button>');
